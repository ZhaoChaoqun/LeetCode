...
public class _301_2 {
    ...
    public static void main(String[] args) {
        System.out.println(new _301_2().removeInvalidParentheses("()())()"));
        System.out.println(new _301_2().removeInvalidParentheses("(a)())()"));
        System.out.println(new _301_2().removeInvalidParentheses(")("));
        System.out.println(new _301_2().removeInvalidParentheses(""));
        System.out.println(new _301_2().removeInvalidParentheses("(()()"));
        System.out.println(new _301_2().removeInvalidParentheses("()(("));
        System.out.println(new _301_2().removeInvalidParentheses("(("));
        System.out.println(new _301_2().removeInvalidParentheses(")(f"));
        System.out.println(new _301_2().removeInvalidParentheses("f)"));
        System.out.println(new _301_2().removeInvalidParentheses(")o(v("));
        System.out.println(new _301_2().removeInvalidParentheses("(r(()()("));
        System.out.println(new _301_2().removeInvalidParentheses("())r)"));
    }
